@extends('c-app', [
    'title' => 'Edit Tanah Polda',
    'showTitle' => true,
])

@section('content')
    <x-card>
        <form action="{{ url('/tanah-polda/' . $tanah_polda->id) }}" method="POST">
            @method('PUT')
            @csrf
            ...
            <table class="un-w-full un-whitespace-nowrap table table-bordered un-bg-gray-50">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="!un-bg-white">
                            <input type="text" class="un-border-none un-bg-transparent un-outline-none un-w-full" required
                                name="nama" value="{{ old('nama', $tanah_polda->nama) }}"
                    ...
                    <tr>
                        ...
                        <td class="!un-bg-white">
                            <input type="number" class="un-border-none un-bg-transparent un-outline-none un-w-full"
                                ...
                                value="{{ old('sudah_sertifikat_jumlah_luas', $tanah_polda->sudah_sertifikat_jumlah_luas) }}"
                                placeholder="0">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="!un-bg-white">
                            <input type="number" class="un-border-none un-bg-transparent un-outline-none un-w-full"
                                ...
                                value="{{ old('sudah_sertifikat_jumlah_persil', $tanah_polda->sudah_sertifikat_jumlah_persil) }}"
                                placeholder="0">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="!un-bg-white">
                            <input type="number" class="un-border-none un-bg-transparent un-outline-none un-w-full"
                                name="hibah_luas" value="{{ old('hibah_luas', $tanah_polda->hibah_luas) }}" placeholder="0">
                        </td>
                    </tr>
                    <tr>
                        <td>Persil (Unit)</td>
                        <td class="!un-bg-white">
                            <input type="number" class="un-border-none un-bg-transparent un-outline-none un-w-full"
                                name="hibah_persil" value="{{ old('hibah_persil', $tanah_polda->hibah_persil) }}"
                                placeholder="0">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="!un-bg-white">
                            <input type="number" class="un-border-none un-bg-transparent un-outline-none un-w-full"
                                name="swadaya_luas" value="{{ old('swadaya_luas', $tanah_polda->swadaya_luas) }}"
                                placeholder="0">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="!un-bg-white">
                            <input type="number" class="un-border-none un-bg-transparent un-outline-none un-w-full"
                                name="swadaya_persil" value="{{ old('swadaya_persil', $tanah_polda->swadaya_persil) }}"
                                placeholder="0">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="!un-bg-white">
                            <input type="number" class="un-border-none un-bg-transparent un-outline-none un-w-full"
                                name="sengketa_luas" value="{{ old('sengketa_luas', $tanah_polda->sengketa_luas) }}"
                                placeholder="0">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="!un-bg-white">
                            <input type="number" class="un-border-none un-bg-transparent un-outline-none un-w-full"
                                name="sengketa_persil" value="{{ old('sengketa_persil', $tanah_polda->sengketa_persil) }}"
                                placeholder="0">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="!un-bg-white">
                            <input type="number" class="un-border-none un-bg-transparent un-outline-none un-w-full"
                                ...
                                value="{{ old('pinjam_pakai_luas', $tanah_polda->pinjam_pakai_luas) }}" placeholder="0">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="!un-bg-white">
                            <input type="number" class="un-border-none un-bg-transparent un-outline-none un-w-full"
                                ...
                                value="{{ old('pinjam_pakai_persil', $tanah_polda->pinjam_pakai_persil) }}"
                                placeholder="0">
                        </td>
                    </tr>
