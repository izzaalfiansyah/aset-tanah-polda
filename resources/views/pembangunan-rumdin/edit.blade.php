@extends('c-app', [
    'title' => 'Edit Pembangunan Rumdin',
    'showTitle' => true,
])

@section('content')
    <x-card title="Edit Pembangunan Rumdin">
        <form action="{{ url('/pembangunan-rumdin/' . $pembangunan_rumdin->id) }}" method="POST">
            @method('PUT')
            @csrf
                ...
                <tbody>
                                ...
                                {{-- <tr>
                                    ...
                                    <td class="!un-bg-white">
                                        <input type="text"
                                            ...
                                            name="nama" value="{{ old('nama', $pembangunan_rumdin->nama) }}"
                    ...
                    @else
                        <tr>
                            ...
                            <td class="!un-bg-white">
                                <input type="text" class="un-border-none un-bg-transparent un-outline-none un-w-full"
                                    required name="nama" value="{{ old('nama', $pembangunan_rumdin->nama) }}"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="!un-bg-white">
                            <input type="text" class="un-border-none un-bg-transparent un-outline-none un-w-full"
                                name="jenis_bangunan"
                                value="{{ old('jenis_bangunan', $pembangunan_rumdin->jenis_bangunan) }}" placeholder="-">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="!un-bg-white">
                            <input type="number" class="un-border-none un-bg-transparent un-outline-none un-w-full"
                                name="tipe" value="{{ old('tipe', $pembangunan_rumdin->tipe) }}" placeholder="0">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="!un-bg-white">
                            <input type="number" class="un-border-none un-bg-transparent un-outline-none un-w-full"
                                name="jumlah" value="{{ old('jumlah', $pembangunan_rumdin->jumlah) }}" placeholder="0">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="!un-bg-white">
                            <input type="text" class="un-border-none un-bg-transparent un-outline-none un-w-full"
                                name="sumber_gar" value="{{ old('sumber_gar', $pembangunan_rumdin->sumber_gar) }}"
                                placeholder="-">
                        </td>
                    </tr>
                </tbody>
                    ...
                    <tr class="!un-bg-white">
                        <td>
                            <textarea name="keterangan" rows="3"
                                class="un-border-none un-bg-transparent un-outline-none un-w-full un-resize-none" placeholder="Masukkan Keterangan">{{ old('keterangan', $pembangunan_rumdin->keterangan) }}</textarea>
                        </td>
                    </tr>
                </tbody>
            </table>
