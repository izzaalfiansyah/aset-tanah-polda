                        ...
                        <tr>
                            ...
                            <td class="!un-bg-white">
                                <input type="text" class="un-border-none un-bg-transparent un-outline-none un-w-full"
                                    required name="nama" value="{{ old('nama', $rumdin_golongan->nama) }}"
                    ...
                    <tr>
                        ...
                        <td class="!un-bg-white">
                            <input type="number" class="un-border-none un-bg-transparent un-outline-none un-w-full"
                                name="jumlah_personel"
                                value="{{ old('jumlah_personel', $rumdin_golongan->jumlah_personel) }}" placeholder="0">
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="un-w-full un-whitespace-nowrap table table-bordered un-bg-gray-50">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="!un-bg-white">
                            <input type="number" class="un-border-none un-bg-transparent un-outline-none un-w-full"
                                name="rumah_dinas_jumlah"
                                value="{{ old('rumah_dinas_jumlah', $rumdin_golongan->rumah_dinas_jumlah) }}"
                                placeholder="0">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="!un-bg-white">
                            <input type="number" class="un-border-none un-bg-transparent un-outline-none un-w-full"
                                name="rumah_dinas_kapasitas"
                                value="{{ old('rumah_dinas_kapasitas', $rumdin_golongan->rumah_dinas_kapasitas) }}"
                                placeholder="0">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="!un-bg-white">
                            <input type="number" class="un-border-none un-bg-transparent un-outline-none un-w-full"
                                name="rumah_dinas_polri_aktif"
                                value="{{ old('rumah_dinas_polri_aktif', $rumdin_golongan->rumah_dinas_polri_aktif) }}"
                                placeholder="0">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="!un-bg-white">
                            <input type="number" class="un-border-none un-bg-transparent un-outline-none un-w-full"
                                name="rumah_dinas_polri_purna"
                                value="{{ old('rumah_dinas_polri_purna', $rumdin_golongan->rumah_dinas_polri_purna) }}"
                                placeholder="0">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="!un-bg-white">
                            <input type="number" class="un-border-none un-bg-transparent un-outline-none un-w-full"
                                name="rumah_dinas_non_polri"
                                value="{{ old('rumah_dinas_non_polri', $rumdin_golongan->rumah_dinas_non_polri) }}"
                                placeholder="0">
                        </td>
                    </tr>
                </tbody>
            ...
            <table class="un-w-full un-whitespace-nowrap table table-bordered un-bg-gray-50">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="!un-bg-white">
                            <input type="number" class="un-border-none un-bg-transparent un-outline-none un-w-full"
                                name="rumah_non_dinas_pribadi"
                                value="{{ old('rumah_non_dinas_pribadi', $rumdin_golongan->rumah_non_dinas_pribadi) }}"
                                placeholder="0">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="!un-bg-white">
                            <input type="number" class="un-border-none un-bg-transparent un-outline-none un-w-full"
                                name="rumah_non_dinas_orang_tua"
                                value="{{ old('rumah_non_dinas_orang_tua', $rumdin_golongan->rumah_non_dinas_orang_tua) }}"
                                placeholder="0">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="!un-bg-white">
                            <input type="number" class="un-border-none un-bg-transparent un-outline-none un-w-full"
                                name="rumah_non_dinas_sewa"
                                value="{{ old('rumah_non_dinas_sewa', $rumdin_golongan->rumah_non_dinas_sewa) }}"
                                placeholder="0">
                        </td>
                    </tr>
                </tbody>
